...
If you would like to use this without ffmpeg, read up on how to convert the files beforehand https://placeholder-software.co.uk/dissonance/docs/Tutorials/Custom-Microphone-Capture.html (Step 4)
